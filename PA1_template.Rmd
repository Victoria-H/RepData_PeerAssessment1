...
```{r MEAN TOTAL STEPS A DAY, echo=TRUE,comment="show"}
...
```{r AVERAGE ACTIVITY, echo=TRUE, comment="show",warning=FALSE}
...
```{r RECALCULATE, echo=TRUE, comment="show" }
...
```{r WEEKEND, echo=TRUE, comment="show"}
